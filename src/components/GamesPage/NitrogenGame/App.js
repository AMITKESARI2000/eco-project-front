...
////////////////////////////////////////////////////////////////////////////////////////
    ...
    function setQuestionList(curIndex){
        ...
        newButtonList[curIndex].questionVisible = !newButtonList[curIndex].questionVisible;
        updateButtonList(newButtonList);
    }
    ...
    return(
        <div className = "main-body">
            <div className ="score">Score: <div style={{color:Score>=0?"lightGreen":"red",display:"inline-block",fontWeight:"1500"}}>{Score}</div></div>
            {
