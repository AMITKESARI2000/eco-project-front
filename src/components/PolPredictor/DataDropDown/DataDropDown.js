        ...
        this.state = {
            ...
            solutions: [
                ...
                },
                {
                    pH: {
                        Acidic:
                            'The most common way to raise the pH of the soil is to add pulverized limestone to the soil. Limestone acts as a soil acid neutralizer and consists of either calcium and magnesium carbonate or calcium carbonate. These are called dolomitic limestone and calcitic limestone respectively.',
                        Alkaline:
                            'Elemental sulfur, aluminium sulfate, iron sulfate, and ammonium sulfate are common amendments used to decrease the soil pH.Spaghnum peat moss is often suggested as a soil amendment to decrease soil pH.  However, most peat moss found in garden centres is neutral or slightly acidic.  Only Canadian spaghnum peat moss has a low pH of 3.0 to 4.5 and will effectively reduce soil pH',
                    },
                },
            ],
            causes: [
                {
                    Nitrogen: [
                        {
                            ImbalanceIsCausedBy:
                                'The fluctuations in nitrogen levels in soil is because of excess usage of both synthetic and organic Nitrogen fertilizers. In rural areas septic tanks contribute a major part in these fluctuations.',
                        },
                        {
                            ImbalanceCauses:
                                'Ground and drinking water pollution. The toxicated water causes respiratory,fertility, kidney problems. Improper growth in infants.',
                        },
                    ],
                },
                {
                    Potassium: [
                        {
                            ImbalanceIsCausedBy:
                                'Insufﬁcient fertilization, excessive ‘table salt’ (sodium) in the root environment, unfavourable soil structure (e.g. sandy soils) and formation of depletion zones around roots.',
                        },
                        {
                            ImbalanceCauses:
                                'Chlorosis, poor growth, reduced yield and poor ﬁbre quality with the increased susceptibility to diseases and pests,effect on photosynthesis,purple or rust brown spots. Leaves often turn or curl radially on the top and entire leaves become necrotic and eventually fall off. Inhibition of flowering and rapid shedding of leaves.',
                        },
                    ],
                },
                {
                    Phosphorus: [
                        {
                            ImbalanceIsCausedBy:
                                'Excessive mining, out of which only 10% enters the agriculture system and is utilised by plants. The remaining 90% is lost because of erosion especially on heavy textured soil.',
                        },
                        {
                            ImbalanceCauses:
                                'Excess phosphorus flows with rain water runoff causing widespread pollution in lakes, rivers and coastal areas, algal blooms and dead zones in the oceans killing aquatic life and producing toxins harmful to humans.',
                        },
                    ],
                },
                {
                    OrganicCarbon: [
                        {
                            ImbalanceIsCausedBy:
                                'Anaerobic (in the absence of oxygen)rotting of organic matter during flood irrigation. Decaying or burning biomass and adding manure. Livestock emissions and waste.',
                        },
                        {
                            ImbalanceCauses:
                                'Greenhouse gases emissions.Around 40% of methane in the global GHG emissions is contributed from agriculture.',
                        },
                    ],
                },
                {
                    pH: {
                        Acidic: [
                            {
                                ImbalanceIsCausedBy:
                                    'Soil acidification is a natural process accelerated by agriculture. Ammonium based fertilisers are major contributors to soil acidification.The main cause of soil acidification is inefficient use of nitrogen, followed by the export of alkalinity in produce.',
                            },
                            {
                                ImbalanceCauses:
                                    'Decreases availability of nutrients to plants. Acidity can degrade the favorable environment for bacteria,earthworm and other soil organisms.',
                            },
                        ],
                        Alkaline: [
                            {
                                ImbalanceIsCausedBy:
                                    'Excess carbonates cause alkalinity in soil. Alkaline irrigation waters may cause soil alkalinity. Continuous use of irrigation water with salt content and use of basic fertilizer Calcium Ammonium Nitrate and excessive overlimiting practice regardless the soil pH.',
                            },
                            {
                                ImbalanceCauses:
                                    'Reduction in availability of nutrients like iron,zinc,copper etc. Iron chlorosis,precipitation.',
                            },
                        ],
                    },
                },
    ...
    changeDistrict(event) {
        ...
        stats === ''
            ...
            : this.setState({
                  ...
                  nutrients: stats.find(
                      (stat) => stat.name === event.target.value
                  ).nutrients,
                  bg: this.backgroundBro(
                      stats.find((stat) => stat.name === event.target.value)
                          .nutrients
                  ),
              });
    }
